...
import itech.pdfreader.documentreader.alldocumentreader.filereader.officereader.databinding.ActivitySearchBinding
...
class SearchActivity : BaseActivity() , MenuBottomSheet.ItemClickListener {
...
//                mainViewModel.addBookmark(id, !isBookmark)
    ...
    private fun initView() {
        ...
        dataViewModel.isObserverChangeAll.observe(this, {
            dataViewModel.retrieveFilesFormDevice {
                fileList = it
