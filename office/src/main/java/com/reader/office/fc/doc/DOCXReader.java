...
package com.reader.office.fc.doc;
...
import com.reader.office.common.PaintKit;
import com.reader.office.common.autoshape.AutoShapeDataKit;
import com.reader.office.common.autoshape.ExtendPath;
import com.reader.office.common.autoshape.pathbuilder.ArrowPathAndTail;
import com.reader.office.common.autoshape.pathbuilder.LineArrowPathBuilder;
import com.reader.office.common.bg.BackgroundAndFill;
import com.reader.office.common.bg.Gradient;
import com.reader.office.common.bg.LinearGradientShader;
import com.reader.office.common.bg.PatternShader;
import com.reader.office.common.bg.RadialGradientShader;
import com.reader.office.common.bg.TileShader;
import com.reader.office.common.bookmark.Bookmark;
import com.reader.office.common.borders.Border;
import com.reader.office.common.borders.Borders;
import com.reader.office.common.borders.Line;
import com.reader.office.common.bulletnumber.ListData;
import com.reader.office.common.bulletnumber.ListLevel;
import com.reader.office.common.hyperlink.Hyperlink;
import com.reader.office.common.pictureefftect.PictureEffectInfo;
import com.reader.office.common.pictureefftect.PictureEffectInfoFactory;
import com.reader.office.common.shape.AbstractShape;
import com.reader.office.common.shape.Arrow;
import com.reader.office.common.shape.AutoShape;
import com.reader.office.common.shape.GroupShape;
import com.reader.office.common.shape.IShape;
import com.reader.office.common.shape.PictureShape;
import com.reader.office.common.shape.ShapeTypes;
import com.reader.office.common.shape.WPAbstractShape;
import com.reader.office.common.shape.WPAutoShape;
import com.reader.office.common.shape.WPChartShape;
import com.reader.office.common.shape.WPGroupShape;
import com.reader.office.common.shape.WPPictureShape;
import com.reader.office.common.shape.WatermarkShape;
import com.reader.office.constant.MainConstant;
import com.reader.office.constant.SchemeClrConstant;
import com.reader.office.constant.wp.WPAttrConstant;
import com.reader.office.constant.wp.WPModelConstant;
import com.reader.office.fc.FCKit;
import com.reader.office.fc.LineKit;
import com.reader.office.fc.ShapeKit;
import com.reader.office.fc.dom4j.Document;
import com.reader.office.fc.dom4j.Element;
import com.reader.office.fc.dom4j.ElementHandler;
import com.reader.office.fc.dom4j.ElementPath;
import com.reader.office.fc.dom4j.io.SAXReader;
import com.reader.office.fc.openxml4j.exceptions.InvalidFormatException;
import com.reader.office.fc.openxml4j.opc.PackagePart;
...
import com.reader.office.fc.ppt.reader.ReaderKit;
import com.reader.office.fc.ppt.reader.ThemeReader;
import com.reader.office.fc.xls.Reader.drawing.ChartReader;
import com.reader.office.java.awt.Rectangle;
import com.reader.office.simpletext.font.FontTypefaceManage;
import com.reader.office.simpletext.model.AttrManage;
import com.reader.office.simpletext.model.IAttributeSet;
...
import com.reader.office.simpletext.model.SectionElement;
import com.reader.office.simpletext.model.Style;
import com.reader.office.simpletext.model.StyleManage;
import com.reader.office.system.AbortReaderError;
import com.reader.office.system.AbstractReader;
import com.reader.office.system.IControl;
import com.reader.office.thirdpart.achartengine.chart.AbstractChart;
import com.reader.office.wp.model.CellElement;
import com.reader.office.wp.model.HFElement;
import com.reader.office.wp.model.RowElement;
import com.reader.office.wp.model.TableElement;
...
public class DOCXReader extends AbstractReader
{
    ...
    private void openFile() throws Exception
    {
        ...
        System.out.println("DOCXReader: Starting document parsing, file: " + filePath);
        ...
        System.out.println("DOCXReader: Document XML parsed successfully");
        ...
        {
            System.err.println("DOCXReader: Error processing document body: " + e.getMessage());
            // 如果处理失败，创建一个基本的文档结构
    ...
    {   
        if (para == null)
        {
            System.err.println("DOCXReader: Null paragraph element, skipping");
            return;
        }
        ...
        // 处理leaf
        boolean hasContent = processRun(para, paraElem, true);
        ...
        {
            // 如果没有内容且偏移量没有前进，创建一个空的叶子元素
            LeafElement emptyLeaf = new LeafElement("");
            emptyLeaf.setStartOffset(offset);
            emptyLeaf.setEndOffset(offset + 1);
            paraElem.appendLeaf(emptyLeaf);
            offset++;
            paraElem.setEndOffset(offset);
            wpdoc.appendParagraph(paraElem, offset);
            
            System.out.println("DOCXReader: Added empty paragraph at offset " + (offset - 1));
        }
    }
...
//            	len++;
    ...
    /**
     * 验证文档是否有有效内容，防止空文档导致无限循环
     */
    private void validateDocument() throws Exception
    {
        System.out.println("DOCXReader: Starting document validation");
        ...
        if (secElem == null)
        {
            System.out.println("DOCXReader: No section element found, creating default section");
            secElem = new SectionElement();
            secElem.setStartOffset(WPModelConstant.MAIN);
            secElem.setEndOffset(WPModelConstant.MAIN + 1);
            wpdoc.appendSection(secElem);
        }
        
        // 检查文档是否有内容
        long mainAreaEnd = wpdoc.getAreaEnd(WPModelConstant.MAIN);
        System.out.println("DOCXReader: Main area end offset: " + mainAreaEnd);
        
        if (mainAreaEnd <= WPModelConstant.MAIN)
        {
            System.out.println("DOCXReader: Empty document detected, creating placeholder content");
            
            // 如果没有内容，创建一个空段落避免布局问题
            ParagraphElement emptyPara = new ParagraphElement();
            emptyPara.setStartOffset(WPModelConstant.MAIN);
            emptyPara.setEndOffset(WPModelConstant.MAIN + 1);
            
            // 创建一个空的文本元素
            LeafElement emptyLeaf = new LeafElement(" "); // 添加一个空格
            emptyLeaf.setStartOffset(WPModelConstant.MAIN);
            emptyLeaf.setEndOffset(WPModelConstant.MAIN + 1);
            emptyPara.appendLeaf(emptyLeaf);
            
            wpdoc.appendParagraph(emptyPara, WPModelConstant.MAIN + 1);
            
            System.out.println("DOCXReader: Added placeholder paragraph");
        }
        else
        {
            // 检查段落数量
            int paraCount = 0;
            long currentOffset = WPModelConstant.MAIN;
            while (currentOffset < mainAreaEnd)
            {
                if (wpdoc.getParagraph(currentOffset) != null)
                {
                    paraCount++;
                    currentOffset++;
                }
                ...
                if (paraCount > 10000)
                {
                    System.err.println("DOCXReader: Too many paragraphs detected, possible parsing error");
                    break;
                }
            }
            System.out.println("DOCXReader: Document contains " + paraCount + " paragraphs");
        }
        
        System.out.println("DOCXReader: Document validation completed");
    }
    
    /**
     * 创建一个后备文档结构，用于处理解析失败的情况
     */
    private void createFallbackDocument()
    {
        System.out.println("DOCXReader: Creating fallback document structure");
        ...
        para.setStartOffset(WPModelConstant.MAIN);
        para.setEndOffset(WPModelConstant.MAIN + 1);
        
        // 添加文本内容
        LeafElement leaf = new LeafElement("Document parsing error. Content may not display correctly.");
        leaf.setStartOffset(WPModelConstant.MAIN);
        leaf.setEndOffset(WPModelConstant.MAIN + 1);
        para.appendLeaf(leaf);
        
        wpdoc.appendParagraph(para, WPModelConstant.MAIN + 1);
        
        // 更新偏移量
        offset = WPModelConstant.MAIN + 1;
        
        System.out.println("DOCXReader: Fallback document created");
    }
}
